...
- 年スライダーの上に年表があります。横軸は表示中の年を中心とした前後50年、縦軸は7分類のレーンで、一時点の出来事は点、期間を持つ出来事は帯です。ホイールで前後10年〜500年に変えられ（広げるほど重要度の高いものに絞られます）、ドラッグで年が動きます。項目をクリックすると詳細が開きます。スマートフォンでは「開く」で表示します。

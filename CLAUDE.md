...
- **年表**（R5a）: 横軸は現在年を中心とした窓、縦軸は分類の 7 レーン（凡例と同じ順・色）。
  ...
  - 未解決: 近現代は項目が多く、1950 年・±50 年（importance 2 以上）で 2,265 件、紛争レーンだけで点 859・帯 248 になり、レーンが点で埋まってラベルが1つも置けない（2026-09-21、ヘッドレス Chrome での実測。1687 年は 345 件でラベル 10）。窓の幅だけでなく件数でも絞る、などの対処は決めていない。

...
- R6b の実測（2026-09-21、同じ環境。確認済みの 4 件を入れた `public/data/events/`。数は、アプリが地図のソースに渡した起点・到達点・線の数で、
  ...
  - 黒死病（Q42005）: 1346 年 0・0 / 1349 年 9・9 / 1353 年 12・12
  - ユスティニアヌスのペスト（Q821711。importance 2 なので zoom 2 以上で出る）: 541 年 2・2 / 543 年 6・6 / 549 年 8・8
  - 活版印刷の伝播（printing-press-spread）: 1450 年 0・0 / 1470 年 6・6 / 1500 年 12・12
  - イスラームの拡大（Q275918）: 632 年 0・0 / 700 年 8・8 / 750 年 12・12
...
- 生成時に、同じ id の項目は diffusion 版で置き換える。R6b（2026-09-21 の build-app-data の出力）で置き換わったのは、手書きのサンプルの
  Q42005（ヨーロッパの黒死病流行、period）と Q821711（ユスティニアヌスのペスト、period）、Wikidata 由来の Q275918（アラブ・イスラミック・コンクエスト、instant、622 年）。
  手書きのサンプルの 2 件は `events.sample.ts` に残っているが、データには出ない。
- **入っているデータ**（R6b、4 件）: 黒死病、ユスティニアヌスのペスト、活版印刷の伝播（slug の id。Wikidata に出来事の項目が無い）、イスラームの拡大
  （start 632 は Wikidata の P580 = 622 から変えている。理由はファイルの `note`）。年・経路の出所と、人が決めた点（黒死病のマルセイユ 1347 年、ジェノヴァとマルセイユの from、
  ユスティニアヌスのペストのアトロパテネの削除）は、各ファイルの `note` / `fromNote` と `diffusion.draft.md` にある。
